...
TOOLTIPS = {
    ...
    "system.donutGravityRingOffset":"Distance orbitale depuis le centre de chaque bouton du donut (0-150 px). Définit le rayon de l'orbite des particules autour des boutons.",
    "system.orbitSpeed":"Vitesse angulaire des particules en orbite autour des boutons (0-5.0). Plus la valeur est élevée, plus les particules tournent rapidement.",
    ...
    "system.orbiterSnapMode":"Mode d'animation pour l'accrochage des particules vers l'orbite : 'default' (easing cubique) ou 'none' (instantané).",
    "system.orbiterDetachMode":"Mode d'animation pour le décrochage des particules de l'orbite : 'default' (easing cubique) ou 'none' (instantané).",
