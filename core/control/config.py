...
SUBPROFILE_PRESETS = dict(
    ...
    geometry=[
        dict(
            ...
            items={
                ...
                "Nuage filamenté": dict(
                    topology="stream_lines",
                    stream_N=18,
                    stream_steps=260,
                    R=1.2,
                    noisy_amp=0.18,
        ...
        dict(
            ...
            items={
                ...
                "Polyèdre étoilé": dict(
                    topology="stellated_icosahedron",
                    stellated_scale=1.8,
                    geo_level=2,
                    poly_link_steps=5,
                ),
        ...
        dict(
            ...
            items={
                ...
                "Flux de Viviani": dict(
                    topology="viviani",
                    N=2200,
                    viviani_a=1.2,
                    helix_turns=2.5,
                ),
                "Courbe de Lissajous": dict(
    ...
    dynamics=[
        ...
        dict(
            category="Oscillations rythmiques",
            items={
                "Balancement doux": dict(
                    rotX=8.0,
                    rotY=-8.0,
                    rotZ=0.0,
                    pulseA=0.18,
    ...
    distribution=[
        ...
        dict(
            ...
            items={
                ...
                "Longitudes alternées": dict(
                    densityMode="by_longitude",
                    maskMode="longitudinal_band",
                    lonWidthDeg=22.0,
                    maskSoftness=0.2,
                    densityPulse=0.35,
                ),
